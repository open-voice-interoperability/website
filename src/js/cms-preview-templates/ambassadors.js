...
export default class AmbassadorsPreview extends React.Component {
  render() {
    ...
    const entryAmbassadors = entry.getIn(["data", "ambassadors"]);
    const ambassadors = entryAmbassadors ? entryAmbassadors.toJS() : [];
    
    return <div>
      <Jumbotron image={image} title={entry.getIn(["data", "title"])} />
      <div className="bg-off-white pv4">
        <div className="mw7 center ph3 pt4">
          {ambassadors.map(({text, heading, imageUrl}, i) =>
